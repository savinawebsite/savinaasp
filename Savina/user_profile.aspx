<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="user_profile.aspx.cs" Inherits="user_profile" %>
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                            <div class="profile_img">
                              ...
                              <ul class="list-unstyled user_data">
                                    <li><i class="fa fa-map-marker user-profile-icon"></i>&nbsp 125 Nguyễn Kiệm, phường 10, quận Phú Nhuận, TP, Ho Chi Minh
                                    </li>
                                    <li>
                                      <i class="fa fa-briefcase user-profile-icon"></i>&nbsp Software Developer
                                    </li>
                                    <li>
                                      <i class="fa fa-calendar user-profile-icon"></i>&nbsp Tham gia:&nbsp 15/03/2018
                                    </li>
                              </ul>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md- col-sm-7 col-xs-12 userprofile-inputform">
                                                <input type="text" id="customerCode" disabled="disabled" class="form-control"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Họ khách hàng</label>
                                            <div class="col-md- col-sm-7 col-xs-12 userprofile-inputform">
                                                <input type="text" id="customerLastname" name="last-name" disabled="disabled"" class="form-control"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Tên khách hàng</label>
                                            <div class="col-md- col-sm-7 col-xs-12 userprofile-inputform">
                                                <input type="text" id="customerFirstname" name="first-name" disabled="disabled" class="form-control"/>
                                            </div>
                                        </div>                                                       
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Email</label>
                                            <div class="col-md- col-sm-7 col-xs-12 userprofile-inputform">
                                                <input type="email" id="customerEmail" name="email" disabled="disabled" class="form-control"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Số điện thoại</label>
                                            <div class="col-md- col-sm-7 col-xs-12 userprofile-inputform">
                                                <input type="number" id="customerPhoneNumber" name="phone-number" disabled="disabled" class="form-control"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Địa chỉ</label>
                                            <div class="col-md- col-sm-7 col-xs-12 userprofile-inputform">
                                                <input type="text" id="customerAddress" name="address" disabled="disabled" class="form-control">
                                            </div>
                                        </div>                          
                                    </div>
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md- col-sm-7 col-xs-12 userprofile-inputform">
                                                    <input type="text" id="customerGroup" name="userGroup" disabled="disabled" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12">Mô tả nhanh</label>
                                                <div class="col-md- col-sm-7 col-xs-12 userprofile-inputform">
                                                    <textarea class="resizable_textarea form-control" disabled="disabled" id="customerDescription" ></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group">
